...
<div class="data_list">
    ...
    <form action="j?action=save" method="post" onsubmit="return checkForm()">
				...
				<input type="hidden" id="uuid" name="uuid" value="${job.uuid }"/>
					...
					<div align="center">
						...
						&nbsp;<button class="btn btn-primary" type="button" onclick="javascript:window.location='j'">返回</button>
					</div>
					<div align="center">
