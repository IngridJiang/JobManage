			...
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="blank"><i class="icon-chevron-right"></i>首页</a></li>
                                        <li><a href="jstu?action=list"><i class="icon-chevron-right"></i>我的简历</a></li>
                                        <li><a href="jobs?action=list"><i class="icon-chevron-right"></i>查看职位</a></li>
					<li><a href="luntan?action=list"><i class="icon-chevron-right"></i>学生论坛</a></li>
