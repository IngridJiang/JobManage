...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >西财就业辅助系统</font></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="qiyeduan?action=list"><i class="icon-chevron-right"></i>企业查看</a></li>
					<li><a href="jq?action=list"><i class="icon-chevron-right"></i>职位查看</a></li>
					<li><a href="tq?action=list"><i class="icon-chevron-right"></i>投递查看</a></li>
					<li><a href="login.jsp"><i class="icon-chevron-right"></i>退出系统</a></li>
				</ul>
			</div>
					<div class="span10">
						<jsp:include page="${mainPage==null?'qiye/blank.jsp':mainPage}"></jsp:include>
					</div>
			</div>
		</div>
</body>
