...
<div class="data_list">
    ...
    <form action="jstu?action=save" method="post" onsubmit="return checkForm()">
		...
		<input type="hidden" id="jianliid" name="jianliid" value="${jianli.jianliid }"/>
						...
						<c:choose>
			<c:when test="${jianli.jianliid!=null }">
                            <input type="hidden" id="studentId" name="studentId" value="${jianli.studentId }"/>    
				 <table align="center">
			</c:when>
			<c:otherwise>
				<table align="center">
		...
		<tr>
					...
					<div align="center">
						...
						&nbsp;<button class="btn btn-primary" type="button" onclick="javascript:window.location='jstu'">返回</button>
					</div>
					<div align="center">
