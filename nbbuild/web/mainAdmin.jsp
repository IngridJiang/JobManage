...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/media/css/dataTables.bootstrap.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/dataTables.bootstrap.js"></script>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >西财就业管理系统</font></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="student?action=list"><i class="icon-chevron-right"></i>学生用户管理</a></li>
					<li><a href="qiyezhanghao?action=list"><i class="icon-chevron-right"></i>企业用户管理</a></li>
                                        <li><a href="q?action=list"><i class="icon-chevron-right"></i>企业管理</a></li>
                                        <li><a href="j?action=list"><i class="icon-chevron-right"></i>职位管理</a></li>
                                        <li><a href="qiyeshenhe?action=list"><i class="icon-chevron-right"></i>企业审核</a></li>
                                        <li><a href="js?action=list"><i class="icon-chevron-right"></i>职位审核</a></li>
                                        <li><a href="jg?action=list"><i class="icon-chevron-right"></i>简历管理</a></li>
					<li><a href="gonggao?action=list"><i class="icon-chevron-right"></i>公告管理</a></li>
                                        <li><a href="luntan?action=list"><i class="icon-chevron-right"></i>论坛管理</a></li>
