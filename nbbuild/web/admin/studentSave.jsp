...
<script type="text/javascript">
	function checkForm(){
		...
		if(userName==""||password==""||rPassword==""||name==""||sex==""||tel==""||email==""||city==""){
				...
				<input type="hidden" id="studentId" name="studentId" value="${student.studentId }"/>
					<table align="center">
						<tr>
							...
							<td><input type="text" id="stuNum"  name="stuNum" value="${student.stuNum }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<select id="sex" name="sex" style="width: 90px;">
									...
									<option value="male" ${student.sex eq "男"?'selected':'' }>男</option>
									<option value="female" ${student.sex eq "女"?'selected':'' }>女</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" id="email"  name="email" value="${student.email }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
                                                <tr>
							<td><font color="red">*</font>城市：</td>
							<td><input type="text" id="city"  name="city" value="${student.city }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
