...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">西财就业辅助系统</font></h2>
		...
		<label class="radio inline">
			<input id="q" type="radio" name="userType" value="q" ${userType==2?'checked':''} /> 企业
		</label>
		<label class="radio inline">
        ...
        <p align="center"><a href="registerstu.jsp" color=white>注册学生用户</a>
             &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="registerq.jsp" color=white>注册企业用户</a></p>
</div>
</body>
</html>